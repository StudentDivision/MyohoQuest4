const CHARACTERS = {
  ...
  cloverbird: {
    ...
    name: "クローバード",
    role: "優しく寄り添う小さな相棒",
    personality: "四つ葉のクローバーをモチーフにした小さな鳥型の相棒。優しく穏やかで、少し臆病だが、主人公を一生懸命励ます。間違いを責めず、学ぶことを希望に変えてくれる存在。",
...
const STORY_TEXTS = {
  prologue: [
    ...
    "クローバードは言った。「教学には、人を励ます力があるんです。一つずつ学べば、きっと迷いを晴らせます。」",
    "こうして、希望の教学を集める旅が始まった。"
  ],
  nameIntro: [
    "旅立つ前に、冒険者の名前を決めましょう。",
    "この名前で、クローバードと一緒に迷いを晴らす旅へ出発します。"
  ],
  beforeFinal: [
