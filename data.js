const CHARACTERS = {
  ...
  cloverbird: {
    ...
    name: "クローバード",
    role: "渋く頼れる相棒",
    personality: "寡黙で落ち着いた相棒。ぶっきらぼうだが面倒見がよく、戦いの中で短く核心を突く。迷いに呑まれそうな主人公を、甘やかさず、しかし決して見捨てずに支える。",
    spriteClass: "sprite-cloverbird",
    spritePath: "",
    fallbackMark: "🍀"
  }
};
...
const CLOVERBIRD_LINES = {
  start: [
    "焦るな。答えは、積み上げた学びの中にある。",
    "迷いの声に飲まれるな。目の前の一問を斬れ。",
    "深く息をしろ。勝負どころほど、静かにいくぞ。",
    "知識は飾りじゃない。人を立たせるための武器だ。",
    "いいか。逃げ道を見るな。問いの芯を見ろ。",
    "ここからだ。お前の一念を立て直せ。"
  ],
  correct: [
    "いい一撃だ。今の答えは、迷いに効いたぜ。",
    "その通りだ。教学は、ただの知識じゃねえ。人を立たせる力だ。",
    "悪くない。今の一問で、霧が薄くなった。",
    "見えたな。答えはいつも、逃げずに向き合った先にある。",
    "その調子だ。お前の学びは、確かに刃になっている。",
    "決まったな。迷いの声より、お前の一念の方が強い。"
  ],
  wrong: [
    "外したか。なら覚えろ。それで一歩前だ。",
    "気にするな。負けは終わりじゃない。立て直す材料だ。",
    "間違いを恐れるな。恐れるべきは、学びを止めることだ。",
    "今ので弱点が見えた。次は斬れる。",
    "いいか、下を向くな。答えを拾って、次に進め。",
    "迷いに一度揺れただけだ。まだ勝負は終わってない。"
  ],
  victory: [
    "よし。迷いは斬った。だが、次の戦いに備えろ。",
    "見事だ。今の勝ちは、知識じゃなく覚悟の勝ちだ。",
    "やったな。お前の一歩が、この場所の霧を晴らした。",
    "いい戦いだった。学んだことを、誰かのために使え。",
    "勝ったな。けど、ここで満足するな。次へ行くぞ。",
    "その武器、ただ飾るなよ。人を励ますために使え。"
  ],
  defeat: [
    "倒れたか。だが、終わりじゃない。立ち上がるまでが勝負だ。",
    "悔しいなら覚えろ。その悔しさは、次の刃になる。",
    "迷いは強い。だからこそ、何度でも挑む価値がある。",
    "休め。だが、逃げるな。次は一問ずつ取り返すぞ。",
    "負けを恥じるな。負けた後にどう立つかで決まる。",
    "ここで折れるな。お前には、まだ進む力がある。"
  ],
  boss: [
    "空気が変わったな。気を抜くな、ここからが本番だ。",
    "相手は迷いそのものだ。飲まれたら終わるぞ。",
    "言葉に惑わされるな。お前が学んできたものを信じろ。",
    "怖いか。なら、その怖さごと前に出ろ。",
    "ここで退いたら、誰かの希望も守れない。腹を決めろ。",
    "迷いの根を断つ。準備はいいな。"
  ],
  final: [
    "第六天の魔王か。上等だ。人は変われるって、叩き込んでやれ。",
    "ここまで来たんだ。最後まで腹を決めろ。",
    "迷いは強い。だが、人の生命はもっと深い。",
    "希望を幻だと言わせるな。お前の一答で証明しろ。",
    "今までの学びを全部使え。ここが決着の場だ。",
    "お前は一人じゃない。積み上げた教学が、背中を押している。"
  ],
  review: [
    "復習だ。地味だが、こういう戦いが一番効く。",
    "間違えた問題は弱点じゃない。鍛える場所だ。",
    "もう一度向き合え。今度は斬れる。",
    "焦るな。取り戻すべき答えは、ちゃんとここにある。",
    "復習から逃げない奴は強くなる。行くぞ。",
    "前に外した一問だな。なら、今度は仕留める。"
  ]
};
...
const STORY_TEXTS = {
  prologue: [
    "世界に、静かな“迷い”が広がっていた。",
    "「どうせ無理だ」「自分なんて、何も変えられない」「人を信じても、傷つくだけだ」――そんな声が、人々の心を少しずつ閉ざしていく。",
    "その声を広げているのは、人のあきらめを力に変える存在――第六天の魔王。",
    "主人公は、旅の途中で一羽の相棒と出会う。名はクローバード。",
    "クローバードは低く言った。「教学は、飾りじゃない。人を立たせるための武器だ。学ぶ覚悟があるなら、俺が最後まで付き合う。」",
    "こうして主人公は、教学という希望の武器を身につけるため、クローバードとともに旅立つ。"
  ],
  nameIntro: [
    "旅立つ前に、君の名を刻め。",
    "この名前は、迷いに立ち向かう冒険者の名になる。"
  ],
  beforeFinal: [
    "六つの地に広がっていた迷いは晴れ、主人公の手には希望の武器が集まった。",
    "しかし、空の彼方にそびえるマヨイの塔から、まだ暗い声が響いている。",
  ...
  ending: [
    ...
    "けれど、迷いはきっと、これからも何度だって現れる。",
    "だからこそ、この旅で得た教学は、ただの記憶では終わらない。"
  ],
  endingAfterword: [
    "クローバードは言った。「迷いは何度でも来る。だが、学び、励まし、行動する心があれば、人はまた立てる。」",
    "「教学は、人を責めるための刃じゃない。人を立たせるための武器だ。忘れるなよ。」",
    "希望の武器は、主人公の中にある。そして、次に励ますべき一人のもとへ、また新しい一歩が始まる。"
  ]
};
